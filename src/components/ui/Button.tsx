  ...
  'inline-flex items-center justify-center gap-1.5 font-bold tracking-wide cursor-pointer select-none whitespace-nowrap rounded-lg transition-[transform,filter,box-shadow] duration-75 active:scale-95 active:brightness-85 disabled:opacity-30 disabled:cursor-not-allowed disabled:pointer-events-none',
  {
    variants: {
      variant: {
        ...
        gold: 'border-2 border-[var(--gold-lo)] bg-gradient-to-b from-[var(--gold-hi)] via-[var(--gold-mid)] to-[var(--gold-lo)] text-[#1a0e04] font-black [box-shadow:inset_0_1px_0_rgba(255,252,200,0.74),inset_0_-2px_0_rgba(0,0,0,0.24),0_3px_0_var(--gold-dim),0_6px_20px_var(--gold-glow-sm)] hover:brightness-110 active:translate-y-[1px] active:[box-shadow:inset_0_1px_0_rgba(255,252,200,0.74),inset_0_-1px_0_rgba(0,0,0,0.24),0_1px_0_var(--gold-dim)]',
        ...
        pixelGold: 'rounded-none border-2 border-[var(--gold-dim)] bg-gradient-to-b from-[var(--gold-hi)] to-[var(--gold)] text-[#1a0e04] [box-shadow:inset_-2px_-2px_0_var(--gold-lo),inset_2px_2px_0_var(--gold-hi),0_4px_0_var(--gold-dim),0_6px_16px_var(--gold-glow-sm)] active:translate-y-[2px] active:[box-shadow:inset_-2px_-2px_0_var(--gold-lo),inset_2px_2px_0_var(--gold-hi),0_2px_0_var(--gold-dim)]',
